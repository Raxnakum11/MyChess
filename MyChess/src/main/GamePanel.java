...
public class GamePanel extends JPanel implements Runnable {
    ...
    public void run() {
        ...
        //GAME LOOP
         // It is a sequence of processes that run continuously as long as the game is running
        ...
        while(gameThread != null){
            ...
            //we use System.naboTime() to measure the elapsed time and call update and repaint methods once every 1/60 of a second
    ...
    private boolean isCheckmate() {
        ...
        if(kingCanMove(king)) {
            ...
            //Check the position of the checking piece and king in check
